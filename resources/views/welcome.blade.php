...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      ...
      <div class="wrapper">
        ...
        <div class="content">
          <div>
            <h1 class="find">Find your outfits on</h1>
            <h1 class ="e"><strong>EFASHION</strong></h1>
          </div>
      ...
      <div class="footer-basic">
        <footer>
          ...
          <p class="copyright">EFASHION © 2022</p>
        </footer>
      </div>

      <script src="https://kit.fontawesome.com/05c9abbfb4.js" crossorigin="anonymous"></script>
